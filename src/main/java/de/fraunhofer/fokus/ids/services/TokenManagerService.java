 ...
 * Originally part of the trusted connector https://github.com/industrial-data-space/trusted-connector
 * Adjusted to infrastructure of Open Data Connector
 *
...
public class TokenManagerService {
    ...
    public Map<String, Object> acquireToken(
        ...
        try {
            ...
            String jwtString = responseBody.string();
